...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.checkGLError(TAG, "OBJ buffer load");

    final int vertexShader =
        com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.object_vertex);
    final int fragmentShader =
        com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, R.raw.object_fragment);
  ...
  public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity) {
    ...
    com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.checkGLError(TAG, "After draw");
  }
