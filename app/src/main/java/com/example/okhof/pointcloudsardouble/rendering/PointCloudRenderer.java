...
//                                                              -- ATTENTION --
  /* THIS IS NOT THE FILE USED FOR POINT CLOUDS CREATED BY
     PATRICK LEY, THE MODIFIED CLASS IS CALLED "POINT CLASS".
   */
public class PointCloudRenderer {
  ...
  public void createOnGlThread(Context context) {
    ...
    int vertexShader =
            com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.point_cloud_vertex);
    ...
    com.google.ar.core.examples.java.helloar.rendering.ShaderUtil.checkGLError(TAG, "program");
